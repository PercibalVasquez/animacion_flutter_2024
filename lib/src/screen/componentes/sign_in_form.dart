import 'package:animacion_flutter_2024/src/entry_point.dart';
...
class _SignInFormState extends State<SignInForm> {
  GlobalKey<FormState> _formKey =
      GlobalKey<FormState>(); // TODO: Crea una clave global para el formulario
  bool isShowLoading =
      false; // TODO: Inicializa la variable isShowLoading en false
  bool isShowConfetti =
      false; // TODO: Inicializa la variable isShowConfetti en false
  ...
  late SMITrigger
      confetti; // TODO: Declara una variable confetti del tipo SMITrigger
        ...
        if (_formKey.currentState!.validate()) {
          ...
          Future.delayed(
            ...
            () {
              ...
              confetti
                  .fire(); // TODO: Activa el gatillo Trigger explosion de la animación confetti
              Future.delayed(
                const Duration(seconds: 1),
                () {
                  Navigator.push(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    onSaved:
                        (email) {}, // TODO: Guarda el valor del correo electrónico
                    decoration: InputDecoration(
                      prefixIcon: Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 8),
                        child: SvgPicture.asset(
                            "assets/icons/email.svg"), // TODO: Muestra el icono del correo electrónico
                      ),
                    ),
                  ),
                ),
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    onSaved:
                        (password) {}, // TODO: Guarda el valor de la contraseña
                    obscureText: true,
                    decoration: InputDecoration(
                      prefixIcon: Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 8),
                        child: SvgPicture.asset(
                            "assets/icons/password.svg"), // TODO: Muestra el icono de la contraseña
                      ),
                    ),
                  ),
                ),
                Padding(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: () {
                      signIn(
                          context); // TODO: Llama a la función signIn al presionar el botón
                    },
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color(
                          0xFFF77D8E), // TODO: Establece el color de fondo del botón
                      minimumSize: const Size(double.infinity,
                          56), // TODO: Establece el tamaño mínimo del botón
                    ...
                    icon: const Icon(
                      ...
                      color: Color(
                          0xFFFE0037), // TODO: Establece el color del icono
                    ),
                ...
                child: RiveAnimation.asset(
                  ...
                  onInit: (artboard) {
                    StateMachineController controller = RiveUtils.getRiveController(
                        artboard); // TODO: Obtiene el controlador de la máquina de estados de la animación Rive
                    check = controller.findSMI("Check")
                        as SMITrigger; // TODO: Encuentra el gatillo Check
                    error = controller.findSMI("Error")
                        as SMITrigger; // TODO: Encuentra el gatillo Error
                    reset = controller.findSMI("Reset")
                        as SMITrigger; // TODO: Encuentra el gatillo Reset
                  },
                ),
              )
            : const SizedBox(),
                  ...
                  child: RiveAnimation.asset(
                    ...
                    onInit: (artboard) {
                      ...
                      confetti = controller.findSMI("Trigger explosion")
                          as SMITrigger; // TODO: Encuentra el gatillo Trigger explosion
                    },
                  ),
                ),
              )
